...
const TABLES_CONFIG: Record<string, TableField[]> = {
  clients: [
    ...
    { table_name: 'clients', field_name: 'telefone', display_name: 'Telefone', description: 'Número de contato' },
    { table_name: 'clients', field_name: 'email', display_name: 'Email', description: 'Endereço de email' },
    { table_name: 'clients', field_name: 'cpf', display_name: 'CPF', description: 'Documento CPF' },
    { table_name: 'clients', field_name: 'data_nascimento', display_name: 'Data Nascimento', description: 'Data de nascimento' },
    ...
    { table_name: 'clients', field_name: 'contato_emergencia', display_name: 'Contato Emergência', description: 'Nome do contato de emergência' },
    { table_name: 'clients', field_name: 'telefone_emergencia', display_name: 'Tel. Emergência', description: 'Telefone de emergência' },
  ...
  visits: [
    ...
    { table_name: 'visits', field_name: 'horario_inicio', display_name: 'Hora Início', description: 'Horário de início' },
    { table_name: 'visits', field_name: 'horario_fim', display_name: 'Hora Fim', description: 'Horário de término' },
    { table_name: 'visits', field_name: 'status', display_name: 'Status', description: 'Status da visita' },
    { table_name: 'visits', field_name: 'observacoes', display_name: 'Observações', description: 'Notas da visita' },
    { table_name: 'visits', field_name: 'fotos', display_name: 'Fotos', description: 'Fotos da visita' },
    { table_name: 'visits', field_name: 'preco', display_name: 'Preço', description: 'Valor da visita' },
    { table_name: 'visits', field_name: 'status_pagamento', display_name: 'Status Pagamento', description: 'Status do pagamento' },
  ],
  services: [
    ...
    { table_name: 'services', field_name: 'status', display_name: 'Status', description: 'Status do serviço' },
    { table_name: 'services', field_name: 'total_visitas', display_name: 'Total Visitas', description: 'Número de visitas' },
    { table_name: 'services', field_name: 'valor_total', display_name: 'Valor Total', description: 'Valor total do serviço' },
    { table_name: 'services', field_name: 'desconto_plataforma', display_name: 'Desconto', description: 'Desconto aplicado' },
  ],
}
