...
export default function ClientsPage() {
  ...
  // Modal de visualiza��o para não-admins
  ...
  const fetchClients = async () => {
    ...
    try {
      if (sortBy === 'recent_services') {
        // Esta ordena��o depende de agregação (última visita realizada) que não
        ...
        // � aplicada apenas na exibição (fatiamento do array já ordenado).
  ...
  const handleClientClick = async (client: Client) => {
    ...
    if (isAdmin) {
      ...
      // Outros perfis abrem a modal de visualiza��o
  ...
  const handleEditSubmit = async (e: React.FormEvent) => {
    ...
    // Prevenir múltiplos envios
    if (updating) {
      toast.error('Aguarde, as altera��es estão sendo salvas...')
      return
    }
  ...
  return (
    <div>
      ...
      {/* Pagina��o (também usada na visão mobile) */}
      ...
      {/* Modal de Visualização para N�o-Admins */}
